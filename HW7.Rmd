...
voted_called <- votes %>%
  ...
  nrow()
voted_called
prop <- voted_called / voters
prop
# 0.01477514
voted_not_called <- votes %>%
...
no_call <- votes %>%
  ...
  nrow()
# 10582
prop1 <- voted_not_called / voters
prop1
# 0.4341121
recurrences1 = c(160, 4701)
sample_size1 = c(247, 10582)
prop.test(recurrences1, sample_size1)
#  0.1411399 0.2659167
```
...
The large-sample 95% confidence interval for the difference in these two proportions was (0.141, 0.266).
